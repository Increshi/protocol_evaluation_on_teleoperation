...
public class IsaacUR3Client : MonoBehaviour
{
    ...
    private const float ContinuousSendIntervalSeconds = 0.016f; // ~60 Hz
    ...
    void Start()
    {
        ...
        UpdateStatus("Ready (UDP+Time)...", Color.white);
    ...
    public void Connect()
    {
        ...
        try
        {
            ...
            Debug.Log($"✅ UDP Connected! Listening on {listenPort}");
    ...
    {
        var wait = new WaitForSeconds(ContinuousSendIntervalSeconds);
